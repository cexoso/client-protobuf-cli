...
describe('插件', () => {
  it('插件', async () => {
    ...
    expect(allFile.map((file) => file.toString()).join('\n')).eq(dedent`
      // ./example.ts
      import { People, encodePeople, decodePeople } from './people'
      import { encodeUint32ToBuffer, EncoderWithoutTag, encodeInt64ToBuffer, encodeMessageToBuffer, encodeInt32ToBuffer, encodeStringToBuffer, encodeFloatToBuffer, encodeBoolToBuffer, encodeEnumToBuffer, encodeRepeatToBuffer, readUint32, defineMessage, readInt64, readInt32, readString, readFloat, readBool, readEnum } from '@protobuf-es/core'
      ...
      // ./people.ts
      import { encodeInt32ToBuffer, encodeStringToBuffer, EncoderWithoutTag, readInt32, readString, defineMessage } from '@protobuf-es/core'
      ...
      import { decodeGetDataReq as _decodeGetDataReq, encodeGetDataReq as _encodeGetDataReq, GetDataReq as _GetDataReq, decodePagination as _decodePagination, encodePagination as _encodePagination, Pagination as _Pagination, decodeBook as _decodeBook, encodeBook as _encodeBook, Book as _Book, decodeData as _decodeData, encodeData as _encodeData, Data as _Data, decodeGetDataRes as _decodeGetDataRes, encodeGetDataRes as _encodeGetDataRes, GetDataRes as _GetDataRes } from './example'
      ...
      // ./peopleHelper.ts
      import { wrapDecode, wrapEncode } from '@protobuf-es/core'
      import { decodePeople as _decodePeople, encodePeople as _encodePeople, People as _People } from './people'
      ...
      import { decodeGetDataReq, encodeGetDataRes } from './exampleHelper'
